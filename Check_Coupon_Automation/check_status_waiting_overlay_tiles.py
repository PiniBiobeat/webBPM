...
def test_connect_to_db():
    ...
    if len(list_orders_with_status_WO) != 0:
        token_url = 'https://monitor.lupa.co.il/api/api.aspx?method=write_error&source=AutomationMonitor&service_api=&error_code=16&active=true&token=&extra_params=' + str(
