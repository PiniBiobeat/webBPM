...
URL = 'https://files.lupa.co.il/lp/hooks.aspx?method=old_coupon&campaign_name=Birthday&messageid=5154647637557248&email=couponsaoutomat@gmail.com&discount=35&days=30'
...
def maks_hook():
    ...
    if response.status_code != 200:
        ...
        slack_notification("not send hook Birthday" + "  -> Birthday     " + FROM_EMAIL)
    print("+++++++++++++++++++++ good +++++++++++++++++++")
    time.sleep(3)
