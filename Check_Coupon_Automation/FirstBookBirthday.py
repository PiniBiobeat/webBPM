...
def send_hook():
    ...
    url = 'https://files.lupa.co.il/lp/hooks.aspx?method=old_coupon&campaign_name=FirstBookBirthday&messageid=5299737748111360&email=lupadevtest@gmail.com&discount=80&days=14'
...
def send_email(subject, message):
    ...
    return requests.post(
        ...
        data={
              "from": "Lupa Automation ,Coupon Automation FirstBookBirthday  <monitor@lupa.co.il>",
              "to": operators,
              "subject": subject,
              "text": message,
              }
...
def if_email_not_exists_send_email(result):
    ...
    send_email("The email not sent ** FirstBookBirthday **", result)
