...
def send_hook():
    ...
    url = 'https://files.lupa.co.il/lp/hooks.aspx?method=old_coupon&campaign_name=IncentiveBookBuyersApp&messageid=4869187602284544&email=lupadevtest@gmail.com&discount=40&days=3'
...
def send_email(subject, message):
    ...
    return requests.post(
        ...
        data={
              "from": "Lupa Automation ,Coupon Automation IncentiveBookBuyersApp  <monitor@lupa.co.il>",
              "to": operators,
              "subject": subject,
              "text": message,
              }
...
def if_email_not_exists_send_email(result):
    ...
    send_email("The email not sent ** IncentiveBookBuyersApp **", result)
