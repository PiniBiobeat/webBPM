...
def send_hook():
    ...
    url = 'https://files.lupa.co.il/lp/hooks.aspx?method=old_coupon&campaign_name=TilesIntro&messageid=6166875740372992&email=lupadevtest@gmail.com&discount=30&days=3'
