...
URL = 'https://files.lupa.co.il/lp/hooks.aspx?method=old_coupon&campaign_name=TilesIntro&messageid=6166875740372992&email=couponsaoutomat@gmail.com&discount=30&days=3'
...
def maks_hook():
    ...
    if response.status_code != 200:
        ...
        slack_notification("not send hook    " + "  -> IncentiveTilesBuyers  " + FROM_EMAIL)
