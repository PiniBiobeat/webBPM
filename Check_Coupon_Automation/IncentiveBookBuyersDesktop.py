...
URL = 'https://files.lupa.co.il/lp/hooks.aspx?method=old_coupon&campaign_name=IncentiveBookBuyersDesktop&messageid=6547051775066112&email=couponsaoutomat@gmail.com&discount=40&days=3'
...
def maks_hook():
    ...
    if response.status_code != 200:
        ...
        slack_notification("not send hook     " + "  -> IncentiveBookBuyersDesktop           " + FROM_EMAIL)
