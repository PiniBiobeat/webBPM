...
from logic.pages.create_user_on_connect_page import CreateUserPage
...
class TestSignUpConnect(TestBaseOnline):

    @pytest.mark.smoke
    @pytest.mark.usefixtures("before_after_test")
    def test_sign_up_with_User_approved_newsletter(self):
        page: CreateUserPage = self.browser_online.navigate(configuration['connect-ui'], CreateUserPage)
